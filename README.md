...
- Format: `YEAR[VARIANT].PHASE.MAJOR.MINOR.PATCH[-b|-p]`
  ...
  - **MAJOR**: Breaking changes since last release (0 means none).
...
- **Functionality**:
  - Prints the latest version tag (e.g., `v2026.s.2.3.4`).
  - Copies the prefix to the clipboard: `vi.` for internal phase, `vYEAR[VARIANT].PHASE.` for other phases (e.g., `v2026.s.`, `v2026a.b.`).
